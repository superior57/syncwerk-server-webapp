...
export class MeetingListComponent implements OnInit {
  ...
  getListMeeting() {
    this.adminService.getListMeeting().subscribe(resp => {
  ...
  startMeeting(meeting) {
    meeting.isStarting = true;
    meeting.isStopping = false;
    const meetingId = meeting.id;
    this.adminService.startMeeting(meetingId).subscribe(resp => {
  ...
  editMeeting(meeting) {
    ...
    this.bsModalRef = this.modalService.show(ModalCreateNewMeetingComponent, {
      class: 'modal-lg admin-create-edit-meeting-modal',
      initialState: {
        isEdit: true,
  ...
  focusOnCreateModal(focus) {
    const createEditMeetingModal = jQuery('.admin-create-edit-meeting-modal');
    if (focus) {
  ...
  stopMeeting(meeting) {
    ...
    const meetingId = meeting.id;
    this.adminService.stopMeeting(meetingId).subscribe(resp => {
      this.getListMeeting();
