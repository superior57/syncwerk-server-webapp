...
export class CodeMirrorService {
  modeInfo: any[] = [
    ...
    {
      name: 'PGP', mimes: ['application/pgp', 'application/pgp-encrypted', 'application/pgp-keys', 'application/pgp-signature'],
      mode: 'asciiarmor', ext: ['asc', 'pgp', 'sig']
    },
    ...
    {
      name: 'CoffeeScript', mimes: ['application/vnd.coffeescript', 'text/coffeescript', 'text/x-coffeescript'],
      mode: 'coffeescript', ext: ['coffee'], alias: ['coffee', 'coffee-script']
    },
    ...
    { name: 'PowerShell', mime: 'application/x-powershell', mode: 'powershell', ext: ['ps1', 'psd1', 'psm1'] },
    {
      ...
      mode: 'properties', ext: ['properties', 'ini', 'in'], alias: ['ini', 'properties']
    },
    ...
    {
      name: 'Shell', mimes: ['text/x-sh', 'application/x-sh'],
      mode: 'shell', ext: ['sh', 'ksh', 'bash'], alias: ['bash', 'sh', 'zsh'], file: /^PKGBUILD$/
    },
  ...
  getMode(extension: string) {
    let resultMode = '';
    for (const mode of this.modeInfo) {
      if (!mode.ext) {
        continue;
      }
      const index = mode.ext.indexOf(extension);
      if (index !== -1) {
